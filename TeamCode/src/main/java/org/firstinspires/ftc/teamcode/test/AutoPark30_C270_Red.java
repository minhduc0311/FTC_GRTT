...
@Autonomous(name = "Auto Park 30s Red (C270)")
public class AutoPark30_C270_Red extends LinearOpMode {
    ...
    // ===== CO THE CHINH: TAG ID FTC (RED) =====
    private static final int TAG_LEFT = 1;
    private static final int TAG_CENTER = 2;
